import { Skill, Project, Experience, Education, ContactInfo, PersonalInfo } from '@/types';
...
export const skills: Skill[] = [
  ...
  { name: 'GraphQL', level: 70, category: 'fullstack' },
  { name: 'Docker', level: 65, category: 'fullstack' },
  { name: 'AWS', level: 60, category: 'fullstack' }
];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A collaborative task management application with real-time updates, built using React and Node.js.',
